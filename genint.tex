...
The problem of determining an appropriate comparison class is a general problem shared with other context-sensitive language, including gradable adjectives and vague quantifers like \emph{many} or \emph{a lot} \cite{...}.
Recently, we have shown that pragmatic reasoning, formalized in a similar model of language understanding, can be used to flexibly adjust the comparison class for interpreting gradable adjectives depending on the context \cite{Tessler2017, tessler2022warm}.
...
Subjective value can enter into speaker and listener behavior in our framework (e.g., as it does in the case of polite language use; \citeNP{yoon2020politeness}), but it is not a part of our core theory of the meaning of generics. 
...
Our model of generic language understanding is a rational model in the mold of \citeA{Anderson1990} and \cite{Marr1980}. 
...
At the same time, rational models of pragmatic reasoning have been shown to be useful models for purposes of studying individual differences \cite{DegenFranke, Bohn}.
